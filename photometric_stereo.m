...
%% Combine normals (Non Naive solution)

% 11. This matlab segment is our non-naive solution to combining normals 
% from different color channels. We desire to retian the NaNs, should they 
% appear, rather than simply setting them to 0, as such we initialize a new
% tensor named normalComb of dimensions image height, image width and 
...
% 12. The variables pComb and qComb will be our derivatives resulting from 
...
% 13. Combine normals the naive way by simply adding them up, followed 
% by converting them into unit vectors
